...
define('TEXT_INFO_NEW_BACKUP', 'Onderbreek het backup proces aub. niet, deze kan een aantal minuten in beslag nemen.');
define('TEXT_INFO_UNPACK', '<br /><br />(na het uitpakken van het bestand uit het archief)');
define('TEXT_INFO_RESTORE', 'Onderbreekt u niet het terugzet proces.<br /><br />Hoe groter de backup hoe langer dit proces duurt!<br /><br />Indien mogelijk gebruik hiervoor uw mysql programma.<br /><br />Bijvoorbeeld:<br /><br /><b>mysql -h' . DB_SERVER . ' -u' . DB_SERVER_USERNAME . ' -p ' . DB_DATABASE . ' < %s </b> %s');
...
define('TEXT_LAST_RESTORATION', 'Laatste terugzetting:');
...
define('SUCCESS_LAST_RESTORE_CLEARED', 'Succes: De laatste terugzet datum is verwijderd.');
