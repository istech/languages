...
define('TABLE_HEADING_DEFINITION_GROUPS', 'Gedefinieerde groepen');
define('TABLE_HEADING_ACTION', 'Actie');

define('TEXT_INFO_IMPORT_INTRO', 'Selecteer aub. welke talen te importeren en het type import welke uitgevoerd dient te worden');
define('TEXT_INFO_EDIT_INTRO', 'Maak aub. de benodigde wijzigingen');
define('TEXT_INFO_EXPORT_INTRO', 'Selecteer welke groepen geexporteerd dienen te worden:');
define('TEXT_INFO_DELETE_INTRO', 'Weet u zeker dat u deze taal wilt verwijderen?');

define('TEXT_INFO_LANGUAGE_NAME', 'Naam:');
define('TEXT_INFO_LANGUAGE_CODE', 'Code:');
define('TEXT_INFO_LANGUAGE_LOCALE', 'Locale:');
define('TEXT_INFO_LANGUAGE_CHARSET', 'Karakterset:');
define('TEXT_INFO_LANGUAGE_DATE_FORMAT_SHORT', 'Datum formaat (kort):');
...
define('TEXT_INFO_SELECT_LANGUAGE', 'Selecteer taal:');
