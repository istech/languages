...
define('HEADING_TITLE', 'Taaldefinities');
...
define('TEXT_INFO_INSERT_INTRO', 'Voer aub. de nieuwe taaldefinitie in met de gerelateerde data');
define('TEXT_INFO_EDIT_INTRO', 'Maak aub. de benodigde wijzigingen');
define('TEXT_INFO_DELETE_INTRO', 'Selecteer aub. welke definities uw wilt verwijderen van de volgende groep:');
