...
error_configuration_file_not_writeable = <p>El server web al parecer no se puede escribir los parámetros del almacén a su archivo de la configuración debido a los problemas del permiso del archivo.</p><p>El archivo de la configuración se localiza en:</p><p>%s</p>
