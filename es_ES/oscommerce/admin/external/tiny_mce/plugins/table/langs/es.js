...
col_limit : 'Has excedido el n&uacute;mero de columnas m&aacute;ximo de {$cols}.',
row_limit : 'Has excedido el n&uacute;mero de filas m&aacute;ximo de {$rows}.',
cell_limit : 'Has excedido el n&uacute;mero de celdas m&aacute;ximo de {$cells}.',
missing_scope: 'Est&aacute;s seguro t&uacute; deseas continuar sin especificar un alcance para esta c&eacute;lula del jefe de la tabla. Sin &eacute;l, puede ser dif&iacute;cil que algunos usuarios con inhabilidades entiendan el contenido o los datos exhibidos de la tabla.',
caption : 'Subt&iacute;tulo de la tabla'
});
