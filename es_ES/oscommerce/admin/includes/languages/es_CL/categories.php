...
*/
  ...
  define('ERROR_CATEGORIES_IMAGE_DIRECTORY_NOT_WRITEABLE', 'Error: El directorio de las imágenes de las categorias no es escribible: ' . realpath('../images/categories'));
