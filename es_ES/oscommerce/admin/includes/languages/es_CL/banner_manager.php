...
define('TEXT_BANNERS_TITLE', 'Título de la bandera:');
...
define('TEXT_BANNERS_IMAGE_TARGET', 'Destinación de la imágen (Guardar como):');
...
define('TEXT_BANNERS_BANNER_NOTE', '<b>Notas de la bandera:</b><ul><li>Usar una imágen o el texto para la bandera - no ambas.</li><li>El texto de HTML tiene prioridad sobre una imágen</li></ul>');
define('TEXT_BANNERS_INSERT_NOTE', '<b>Notas de la imágen:</b><ul><li>¡Los directorios deben tener disposición apropiada de los permisos del usuario (escribir)!</li><li>No completar \'Guardar Como\' campo si no agregar una imágen al servidor web (EJ, si esta usando una imágen local (del servidor)).</li><li>El campo de \'Guardar como\' debe ser un directorio existente con un eslach de la conclusión (ej., banderas/).</li></ul>');
define('TEXT_BANNERS_EXPIRCY_NOTE', '<b>Notas de la Expiración:</b><ul><li>Solamente uno de los dos campos debe ser sometido</li><li>Si la bandera no se expira automticamente, entonces deja estos campos en blanco</li></ul>');
define('TEXT_BANNERS_SCHEDULE_NOTE', '<b>Nota de la Programación:</b><ul><li>Si se fija un horario, la bandera ser activada esa fecha.</li><li>Todas las banderas programadas están marcadas como desactivadas hasta que su fecha ha llegado, a la cual entonces serán marcadas activas.</li></ul>');
...
define('TEXT_BANNERS_LAST_3_DAYS', '3 ultimos dias');
...
define('TEXT_INFO_DELETE_IMAGE', 'Borrar imágen de la bandera');
...
define('SUCCESS_BANNER_STATUS_UPDATED', 'Exito: El estatus de la bandera se ha actualizada.');
...
define('ERROR_IMAGE_DOES_NOT_EXIST', 'Error: Imágen no existe.');
define('ERROR_IMAGE_IS_NOT_WRITEABLE', 'Error: No se puede quitar la imágen.');
