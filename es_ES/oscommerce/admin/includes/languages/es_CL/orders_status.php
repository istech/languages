...
define('TEXT_INFO_DELETE_PROHIBITED_HISTORY', 'Advertencia: Este estatus del pedido se usa actualmente en la historia del estatus del pedido de %s pedidos y no puede ser quitado.');
?>
