...
define('TABLE_HEADING_PRICE_INCLUDING_TAX', 'Pris (ink)');
define('TABLE_HEADING_TOTAL_EXCLUDING_TAX', 'Total (ex)');
define('TABLE_HEADING_TOTAL_INCLUDING_TAX', 'Total (ink)');
...
define('ENTRY_BILLING_ADDRESS', 'Fakurerings Adress:');
define('ENTRY_PAYMENT_METHOD', 'Betalnings Form:');
define('ENTRY_CREDIT_CARD_TYPE', 'Kreditkorts Typ:');
define('ENTRY_CREDIT_CARD_OWNER', 'Kreditkorts Innehavare:');
...
define('ENTRY_POST_TRANSACTION_ACTIONS', 'Efter Transaktions Funktioner:');
...
define('TEXT_DELETE_BATCH_INTRO', 'Är du säker du will ta bort följande ordrar?');
define('TEXT_INFO_RESTOCK_PRODUCT_QUANTITY', 'Återställ produkt i lager');
define('TEXT_DATE_ORDER_CREATED', 'Skapad Den:');
define('TEXT_DATE_ORDER_LAST_MODIFIED', 'Senaste Ändring:');
define('TEXT_INFO_PAYMENT_METHOD', 'Betalnings Form:');

define('TEXT_ALL_ORDERS', 'Alla Ordrar');
define('TEXT_NO_ORDER_HISTORY', 'Ingen Tillgänglig Order Historik');

define('EMAIL_SEPARATOR', '------------------------------------------------------');
define('EMAIL_TEXT_SUBJECT', 'Orderuppdatering');
...
define('EMAIL_TEXT_STATUS_UPDATE', 'Din order har blivit uppdaterad till följande status.' . "\n\n" . 'Ny status: %s' . "\n\n" . 'Var vänlig och svara på detta brev om du har några frågor.' . "\n");
define('EMAIL_TEXT_COMMENTS_UPDATE', 'Kommentarer till din order är' . "\n\n%s\n\n");

define('ERROR_ORDER_DOES_NOT_EXIST', 'Fel: Ordern existerar ej.');
define('SUCCESS_ORDER_UPDATED', 'Utfört: Ordern har uppdaterats.');
define('WARNING_ORDER_NOT_UPDATED', 'Varning: Inget att ändra. Ordern uppdaterades ej.');
?>