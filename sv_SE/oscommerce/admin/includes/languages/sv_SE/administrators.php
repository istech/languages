...
*/
  ...
  define('TEXT_EDIT_BATCH_INTRO', 'Var vänlig och gör nödvändiga ändringar till följande administratörer:');
  ...
  define('TEXT_DELETE_BATCH_INTRO', 'Är du säker att du vill ta bort följande administratörer?');

  define('TEXT_GLOBAL_ACCESS', 'Global Access');

  define('ERROR_ADMINISTRATORS_USERNAME_EXISTS', 'Fel: Administratör användarnamn finns redan.');
?>