...
*/
  ...
  define('HEADING_TITLE', 'Nyhetsbrevshanteraren');
  ...
  define('TEXT_INFO_DELETE_INTRO', 'Är du säker att du vill ta bort nyhetsbrevet?');
  ...
  define('ERROR_NEWSLETTER_TITLE', 'Fel: Nyhetsbrev saknar titel');
