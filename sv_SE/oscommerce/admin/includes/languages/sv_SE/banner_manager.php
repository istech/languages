...
define('TEXT_BANNERS_SCHEDULE_NOTE', '<b>Schemanotering:</b><ul><li>Om ett schema är valt så kommer reklambanderollen att aktiveras detta datum.</li><li>Alla schedmalagda reklambanderoller är markerade som inaktiverade tills dess startdatum infaller, då de kommer att markeras som aktiva.</li></ul>');
