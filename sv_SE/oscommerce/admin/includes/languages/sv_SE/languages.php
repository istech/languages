...
table_heading_definition_groups = Definitionsgrupper
table_heading_total_definitions = Antal Definitioner

action_heading_import_language = Importera Språk
action_heading_batch_delete_languages = Ta Bort Språk I Grupp
action_heading_new_language_definition = Ny Språkdefinition

field_name = Namn:
field_code = Kod:
field_locale = Lokal:
field_character_set = Teckenuppsättning:
field_text_direction = Textriktning:
field_date_format_short = Datumformat (Kort):
field_date_format_long = Datumformat (Långt):
field_time_format = Tidsformat:
...
field_import_type = Typ av Importering:

field_export_with_data = Exportera med Språkdata

field_definition_key = Definitionsnyckel:
field_definition_value = Definitionsvärde:
field_definition_group = Grupp:
