...
define('TEXT_INFO_EXPORT_INTRO', 'Var vänlig och välj vilken grupp att exportera:');
define('TEXT_INFO_DELETE_INTRO', 'Är du säker att du vill ta bort språket?');

define('TEXT_INFO_LANGUAGE_NAME', 'Namn:');
define('TEXT_INFO_LANGUAGE_CODE', 'Kod:');
define('TEXT_INFO_LANGUAGE_LOCALE', 'Lokal:');
define('TEXT_INFO_LANGUAGE_CHARSET', 'Teckenuppsättning:');
define('TEXT_INFO_LANGUAGE_DATE_FORMAT_SHORT', 'Datumformat (Kort):');
define('TEXT_INFO_LANGUAGE_DATE_FORMAT_LONG', 'Datumformat (Långt):');
define('TEXT_INFO_LANGUAGE_TIME_FORMAT', 'Tidsformat:');
define('TEXT_INFO_LANGUAGE_TEXT_DIRECTION', 'Textflyt:');
define('TEXT_INFO_LANGUAGE_IMAGE', 'Bild:');
define('TEXT_INFO_LANGUAGE_DEFAULT_CURRENCY', 'Standardvaluta:');
define('TEXT_INFO_LANGUAGE_NUMERIC_SEPARATOR_DECIMAL', 'Numerisk Decimal Skiljare');
define('TEXT_INFO_LANGUAGE_NUMERIC_SEPARATOR_THOUSANDS', 'Numerisk Tusendels Skiljare');
