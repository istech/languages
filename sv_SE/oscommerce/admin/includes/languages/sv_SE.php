...
define('BOX_CONFIGURATION_CREDIT_CARD_TYPES', 'Typer av Kreditkort');
...
define('BOX_CATALOG_SPECIALS', 'Special');
...
// javascript messages
define('JS_ERROR', 'Ett fel har uppstått vid bearbetning av ditt formulär!\nVar vänlig och gör följande ändring:\n\n');
define('JS_OPTIONS_VALUE_PRICE', '* Det nya produktattributet behöver ett pris\n');
...
define('JS_PRODUCTS_MODEL', '* Den nya produkten behöver ett modelnamn\n');
...
define('ENTRY_GENDER_ERROR', 'Var vänlig välj ditt kön.');
...
define('ENTRY_EMAIL_ADDRESS_ERROR_EXISTS', 'Din E-postadress finns redan i vårat register - var vänlig och logga in med din e-post adress eller skapa ett nytt konto med en annan adress.');
define('ENTRY_COMPANY', 'Företagsnamn:');
define('ENTRY_COMPANY_ERROR', 'Namnet på ditt företag måste innehålla minst ' . ACCOUNT_COMPANY . ' tecken.');
define('ENTRY_STREET_ADDRESS', 'Gatuadress:');
define('ENTRY_STREET_ADDRESS_ERROR', 'Namnet på din gatuadress måste innehålla minst ' . ACCOUNT_STREET_ADDRESS . ' tecken.');
define('ENTRY_SUBURB', 'Ort:');
define('ENTRY_SUBURB_ERROR', 'Namnet på din ort måste innehålla minst ' . ACCOUNT_SUBURB . ' tecken.');
...
define('ENTRY_CITY_ERROR', 'Namnet på din stad måste innehålla minst ' . ACCOUNT_CITY . ' tecken.');
define('ENTRY_STATE', 'Län:');
define('ENTRY_STATE_ERROR', 'Namnet på ditt län måste innehålla minst ' . ACCOUNT_STATE . ' tecken.');
...
define('ENTRY_PASSWORD_CONFIRMATION', 'Lösenordsbekräftelse:');
...
define('IMAGE_NEW_PRODUCT', 'Ny Vara');
...
define('IMAGE_UPDATE', 'Updatera');
define('IMAGE_UPDATE_CURRENCIES', 'Updatera Valutakurs');
define('IMAGE_UPLOAD', 'Skicka upp');
...
define('ICON_FILE_DOWNLOAD', 'Tanka hem');
...
define('TEXT_DISPLAY_NUMBER_OF_BANNERS', 'Visar <b>%d</b> till <b>%d</b> (av <b>%d</b> reklamer)');
...
define('TEXT_DISPLAY_NUMBER_OF_PRODUCTS_EXPECTED', 'Visar <b>%d</b> till <b>%d</b> (av <b>%d</b> väntade produkter)');
...
define('ERROR_DESTINATION_NOT_WRITEABLE', 'Fel: Destination ej skrivbar.');
define('ERROR_FILE_NOT_REMOVEABLE', 'Fel: Jag kan ej flytta filen. Var vänlig och ändra användarrättigheterna vid: %s');
define('ERROR_FILE_NOT_SAVED', 'Fel: Uppskickad fil ej sparad.');
define('ERROR_FILETYPE_NOT_ALLOWED', 'Fel: Uppskickad filtyp ej tillåten.');
define('SUCCESS_FILE_SAVED_SUCCESSFULLY', 'Utfört: Uppskickad fil sparad.');
define('WARNING_NO_FILE_UPLOADED', 'Varning: Ingen fil uppskickad.');
