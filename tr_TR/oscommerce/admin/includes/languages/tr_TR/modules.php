...
define('HEADING_TITLE_MODULES_PAYMENT', 'Ödeme Modülleri');
define('HEADING_TITLE_MODULES_SHIPPING', 'Kargo Modülleri');
define('HEADING_TITLE_MODULES_ORDER_TOTAL', 'Sipariş Toplamı Modülleri');
