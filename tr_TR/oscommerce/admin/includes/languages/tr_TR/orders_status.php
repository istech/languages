...
define('TEXT_INFO_DELETE_PROHIBITED', 'Uyarı: Varsayılan sipariş durumu kaldırılamaz. Lütfen diğer sipariş durumunu varsayılan yapın ve tekrar deneyiniz.');
define('TEXT_INFO_DELETE_PROHIBITED_ORDERS', 'Uyarı: Bu sipariş durumu %s siparişinde halen kullanılmaktadır ve silinemez.');
define('TEXT_INFO_DELETE_PROHIBITED_HISTORY', 'Uyarı: Bu sipariş durumu, sipariş geçmisindeki %s siparişi içinde halen kullanılmaktadır ve silinemez.');
?>
