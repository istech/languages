...
define('EMAIL_WELCOME', '<b>' . STORE_NAME . '</b> mağazamınzdan size hoş gediniz diyoruz.' . "\n\n");
define('EMAIL_TEXT', 'Sizin için sunduğumuz <b>çeşitli servisler</b> şimdi katılabilirsiniz. Bu servisleriden bazılarının içerikleri:' . "\n\n" . '<li><b>Kalıcı Alışveriş Sepeti</b> - Herhangi bir ürünü çevrimiçi sepetinize eklediginizde siz bunları kaldırana kadar veya onların hesabını görünceye kadar saklı kalır.' . "\n" . '<li><b>Adres Defteri</b> - Şu an ürünlerinizi sizin adresinizden başaka bir adrese gönderebiliriz! Doğum günü olan kişinin kendisine doğrudan doğum günü hedyesi göndermek için harikadır.' . "\n" . '<li><b>Sipariş Geçmişi</b> - Bizimle yapmış olduğunuz satınalma işlemlerinin geçmişini görünüz.' . "\n" . '<li><b>Ürün Yorumları</b> - Ürünler üzerindeki fikirlerinizi diğer müşterilerle paylaşınız.' . "\n\n");
define('EMAIL_CONTACT', 'Çevrimiçi hizmetlerimizin herhangi birinden yardım almak için lütfen mağaza sahibine eposta gönderizin: ' . STORE_OWNER_EMAIL_ADDRESS . '.' . "\n\n");
