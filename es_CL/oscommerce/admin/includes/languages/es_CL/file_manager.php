...
*/
  ...
  define('ERROR_FILE_NOT_WRITEABLE', 'Error: No puede escribir a este archivo. Por favor fijar los permisos del usuario: %s');
  define('ERROR_DIRECTORY_NOT_REMOVEABLE', 'Error: No puede borrar este directorio. Por favor fijar los permisos del usuario: %s');
