...
define('TEXT_DELETE_BATCH_INTRO', '¿Esta seguro que quiere borrar los siguientes paises?');
define('TEXT_DELETE_BATCH_ZONES_INTRO', '¿Esta seguro que quiere borrar las siguientes zonas?');
...
define('TEXT_INFO_INSERT_ZONE_INTRO', 'Por favor crear la nueva zona con sus datos relacionados');
define('TEXT_INFO_DELETE_ZONE_INTRO', '¿Esta seguro que quiere borrar esta zona?');
define('TEXT_INFO_HEADING_NEW_ZONE', 'Nueva Zona');
define('TEXT_INFO_ZONES_NAME', 'Nombre de Zonas:');
define('TEXT_INFO_ZONES_CODE', 'Código de Zonas:');
...
define('TEXT_INFO_BATCH_DELETE_PROHIBITED_ADDRESS_BOOK', 'Advertencia: Los siguientes países no pueden ser borrados mientras que se asignan actualmente a las entradas del libro de dirección');
define('TEXT_INFO_BATCH_DELETE_PROHIBITED_TAX_ZONES', 'Advertencia: Los siguientes países no pueden ser borrados mientras que se asignan actualmente a las zonas del impuesto. ');
define('TEXT_INFO_BATCH_DELETE_ZONES_PROHIBITED_ADDRESS_BOOK', 'Advertencia: Las siguientes zonas no pueden ser borradas mientras que se asignan actualmente a las entradas del libro de dirección.');
define('TEXT_INFO_BATCH_DELETE_ZONES_PROHIBITED_TAX_ZONES', 'Advertencia: Las siguientes zonas no pueden ser borradas mientras que se asignan actualmente a las zonas del impuesto. ');
