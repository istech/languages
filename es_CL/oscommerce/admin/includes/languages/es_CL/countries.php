...
define('TEXT_INFO_INSERT_INTRO', 'Por favor entrar el país nuevo con sus datos relacionados');
...
define('TEXT_INFO_DELETE_PROHIBITED_ADDRESS_BOOK', 'Advertencia: Este País no puede ser borrado mientras que se asigna actualmente a las entradas de mis direcciones de %s.');
define('TEXT_INFO_DELETE_PROHIBITED_TAX_ZONES', 'Advertencia: Este País no puede ser borrado mientras que se asigna actualmente a las zonas del impuesto de %s.');
