...
define('TEXT_INFO_RESTORE', 'No interrumpir el proceso de la restauración.<br /><br />¡Cuanto más grande es el respaldo, este proceso dura!<br /><br />Si es posible, usa el cliente del mysql.<br /><br />Ejemplo:<br /><br /><b>mysql -h' . DB_SERVER . ' -u' . DB_SERVER_USERNAME . ' -p ' . DB_DATABASE . ' < %s </b> %s');
define('TEXT_INFO_RESTORE_LOCAL', 'No interrumpir el proceso de la restauración.<br /><br />¡Cuanto más grande es el respaldo, este proceso dura!');
