...
define('HEADING_TITLE', 'Zonas de Impuesto');
...
define('TEXT_INFO_NEW_ZONE_INTRO', 'Por favor ingresar la información de la nueva zona');

define('TEXT_INFO_HEADING_EDIT_ZONE', 'Editar Zona');
define('TEXT_INFO_EDIT_ZONE_INTRO', 'Por favor realizar cualquier cambio necesario');
...
define('TEXT_INFO_NEW_SUB_ZONE_INTRO', 'Por favor ingresar la información de la nueva sub zona');

define('TEXT_INFO_HEADING_EDIT_SUB_ZONE', 'Editar Sub Zona');
define('TEXT_INFO_EDIT_SUB_ZONE_INTRO', 'Por favor realizar cualquier cambio necesario');

define('TEXT_INFO_HEADING_DELETE_SUB_ZONE', 'Borrar Sub Zona');
define('TEXT_INFO_DELETE_SUB_ZONE_INTRO', '¿Esta seguro que quiere borrar esta sub zona?');
